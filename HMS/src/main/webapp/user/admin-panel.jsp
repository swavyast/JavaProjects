				...
				<div id="mycar" class="carousel slide" data-bs-ride="carousel">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img id="pin" src="../images/location-icon-png.png" alt="" width="10" height="10"> <img
								src="../images/wmap-white.png" class="d-block w-100 wmap" data-bs-interval="1000" alt="x">
						</div>
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<form action="../countUsers" method="post">
								<button type="button" class="btn bg-success text-light mt-2" data-bs-toggle="modal"
									data-bs-target="#exampleModal1">Count Users</button>
							</form>
							<!-- Modal button -->
						</div>
					</div>
			...
			<div class="col-md-6">
				<div class="card card-shadow">
					<div class="card-body">
						...
						<br>
						<!-- Modal button -->
						<button type="button" class="btn bg-success text-light mt-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<input id="sp_name" class="col-md-12" type="text" name="speciality"
						placeholder="Cardiology, Urology, Neurology something like that">
				</div>
