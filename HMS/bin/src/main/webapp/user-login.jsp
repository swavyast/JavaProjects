		...
		<div class="col-md-4 offset-md-4">
			<div class="card card-shadow">
				...
				<div class="card-body">
					<form method="post" action="user">
						<span class="fs-6 text-danger mx-auto"> <c:if test="${not empty response}">
	           ${response}
            <c:remove var="response" scope="session" />
					...
					<!-- 						<p class="card-caption">I'll write something about this card
							in future.</p> -->
					<div class="row d-block mt-4 mx-auto">
							<a class="col-md-4 btn btn-secondary p-2 d-inline-block" href="doctor-login.jsp"> Doctor Login</a>
							<a class="col-md-4 btn btn-secondary p-2 d-iline-block" href="admin-login.jsp"> Admin Login</a>
					</div>
				</div>
