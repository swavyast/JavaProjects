	...
	<div class="container p-5">
		...
		<div class="row">
				...
				<div class="card pt-2 card-shadow">
					...
					<div class="card-body p-2 mt-4">
						...
						<p class="fs-5 text-center mt-5 text-info">
							Registered already?
							<a class="text-light bg-primary clink p-2 m-2" href="user-login.jsp">Login</a>
						</p>
            ...
            <c:remove var="response" scope="session" />
								...
								<input class="col-md-12 p-2 mt-2" value="" type="text" name="fname" placeholder="First Name" required>
								<input class="col-md-12 p-2 mt-2" value="" type="text" name="lname" placeholder="Last Name" required>
								<input class="col-md-12 p-2 mt-2" value="" type="date" name="dob" placeholder="Date of Birth" required>
								<input class="col-md-12 p-2 mt-2" value="" type="tel" name="phone" placeholder="Your Contact Number" required>
								...
								<small id="passwordHelpBlock" class="form-text text-muted text-center"> You can attach your profile
									picture here, preferred size 400x400 </small><br>
